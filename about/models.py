...
class AboutPage(Page):
	...
	fourth_member_of_team_img = models.ForeignKey(
		"wagtailimages.Image",
		blank=False,
		null=True,
		related_name="+",
	...
	fourth_member_of_team_twitter = models.URLField(verbose_name='Twitter web page', null=True, blank=True, unique=True)
	fourth_member_of_team_facebook = models.URLField(verbose_name='Facebook web page', null=True, blank=True, unique=True)
	fourth_member_of_team_instagram = models.URLField(verbose_name='Email Address', null=True, blank=True, unique=True)
	fourth_member_of_team_linkedin = models.URLField(verbose_name='Linedin web page', null=True, blank=True, unique=True)
	fourth_member_of_team_name = models.CharField('Full Name', max_length=30, default=" ")
	fourth_member_of_team_position = models.CharField('Organizational Position', max_length=30, default=" ")
	fourth_member_of_team_description = models.CharField('Description', max_length=100, default=" ")
	...
	ImageChooserPanel('fourth_member_of_team_img'),
	FieldPanel('fourth_member_of_team_twitter', classname="full"),
	FieldPanel('fourth_member_of_team_facebook', classname="full"),
	FieldPanel('fourth_member_of_team_instagram', classname="full"),
	FieldPanel('fourth_member_of_team_linkedin', classname="full"),
	FieldPanel('fourth_member_of_team_name', classname="full"),
	FieldPanel('fourth_member_of_team_position', classname="full"),
	FieldPanel('fourth_member_of_team_description', classname="full"),
	]
